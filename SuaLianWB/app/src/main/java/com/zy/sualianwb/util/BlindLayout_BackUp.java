 ...
 */
public class BlindLayout_BackUp extends LinearLayout {
    ...
    public BlindLayout_BackUp(Context context) {
        super(context);
        init();
    }

    public BlindLayout_BackUp(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BlindLayout_BackUp(Context context, AttributeSet attrs, int defStyleAttr) {
